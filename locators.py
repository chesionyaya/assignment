...
locator = {
    ...
    "Signin_link":(By.CSS_SELECTOR,"#load_form > div:nth-child(12) > div.span_3_of_4 > p > a"),
    "Username_login":(By.CLASS_NAME,"fancybox"),
    "Password_login":(By.CSS_SELECTOR,"#load_form > fieldset:nth-child(6) > input[type=password]"),
